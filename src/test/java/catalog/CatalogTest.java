...
public class CatalogTest {
    ...
    protected static Logger logger = catalog.Logger.getInstance();
    ...
    public void init() {
        ...
        logger.info("Click on the catalog");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    }
    ...
    public void testCheckElectronics() {
        ...
        logger.info("Checking the Еlectronics section");
    }
    ...
    public void testCheckComputersAndNetworks() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the section Computers and networks");
    }
    ...
    public void testCheckAppliances() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the electronics section");
    }
    ...
    public void testCheckConstructionAndRepair() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the section Construction and repair");
    }
    ...
    public void testCheckHouseAndGarden() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the Home and Garden section");
    }
    ...
    public void testCheckAutoAndMoto() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the Auto and Moto section");
    }
    ...
    public void testCheckBeautyAndSports() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the section Beauty and sports");
    }
    ...
    public void testCheckForChildrenAndMothers() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the section for Children and mothers");
    }
    ...
    public void testCheckWorkAndOffice() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the Work and Office section");
    }
    ...
    public void testCheckFood() {
        ...
        Assert.assertTrue(expected);
        logger.info("Checking the Food section");
    }
